...
###
###############################################################################################################################################
### File:           07.4_dotPlot_mummer_USMA_Pipeline.py
...
def mapping (smpls_ID):
    ...
    output_figures_path = wd_project + "analysis/DeNovoAssembly/DotPlot/figures/Query_lenght" + query_lenght + "/"
    ...
    output_dotPlot = smpls_ID + "_dotPlot." + query_lenght
    ...
    print ("cd " + output_figures_path, file = sge)    
